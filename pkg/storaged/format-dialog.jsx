...
import {
    dialog_open,
    TextInput, PassInput, CheckBox, SelectOne, SizeSlider,
    FieldSet, BlockingMessage, TeardownMessage
} from "./dialog.jsx";
...
export function crypto_options_dialog_fields(options, visible) {
    ...
    return [
        FieldSet("crypto_options", _("Encryption Options"),
                 { visible: visible,
                   value: { auto: opt_auto,
                            ro: opt_ro,
                            extra: extra_options === "" ? false : extra_options },
                   fields: [
                       { title: _("Unlock at boot"), tag: "auto", type: "checkbox" },
                       { title: _("Unlock read only"), tag: "ro", type: "checkbox" },
