            ...
            <div>
                <DescriptionList className="pf-m-horizontal-on-sm">
                    ...
                    <DescriptionListGroup>
                        ...
                        <DescriptionListDescription>
                            { passphrase_path ? this.state.stored_passphrase_mtime || _("yes") : _("none") } { "\n" }
                            <StorageLink onClick={edit_stored_passphrase}>{_("edit")}</StorageLink>
                        </DescriptionListDescription>
                    </DescriptionListGroup>
                    <DescriptionListGroup>
                        ...
                        <DescriptionListDescription>
                            { old_options || _("none") } { "\n" }
                            <StorageLink onClick={edit_options}>{_("edit")}</StorageLink>
                        </DescriptionListDescription>
                    </DescriptionListGroup>
                </DescriptionList>
                <br />
