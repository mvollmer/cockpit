...
$(function() {
    ...
    function create_problem_details(problem, pi, pd) {
        service.GetProblemData(problem.path).done(function(args, options) {
            ...
            var c1 = $('<div>').css('display', 'inline-block')
            ...
            var c2 = $('<div>').css('display', 'inline-block')
                               .css('vertical-align', 'top');
            pi.append(c2);
    ...
    $(cockpit).on("locationchanged", function() {find_problems().done(update);});
