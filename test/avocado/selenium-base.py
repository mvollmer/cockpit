...
class BasicTestSuite(SeleniumTest):
    ...
    def test50ChangeTabLogs(self):
        ...
        b.click("#journal-prio-menu span.caret")
        b.click("#journal-prio-menu a:contains('Only Problems')")
        self.wait_id("journal")
        self.wait_id("journal-current-day")
        b.click("#journal-prio-menu span.caret")
        b.click("#journal-prio-menu a:contains('Problems, Errors')")
        self.wait_id("journal")
        self.wait_id("journal-current-day")
        b.click("#journal-prio-menu span.caret")
        b.click("#journal-prio-menu a:contains('Problems, Errors, Warnings')")
        self.wait_id("journal")
        self.wait_id("journal-current-day")
        b.click("#journal-prio-menu span.caret")
        b.click("#journal-prio-menu a:contains('Problems, Errors, Warnings, Notices')")
        self.wait_id("journal")
        self.wait_id("journal-current-day")
        checkt = "ahojnotice"
